---
name: note-juridique
description: Note de synthèse juridique structurée combinant code, jurisprudence et JO
arguments:
  - name: sujet
    description: Sujet ou question juridique (ex "rupture conventionnelle d'un salarié protégé")
    required: true
  - name: format
    description: "courte" (1 page) ou "complete" (note structurée détaillée). Défaut "complete"
    required: false
---
...
**Sujet** : {{sujet}}
**Format** : {{format | default: "complete"}}
...
Démarre par le cadrage et l'identification des fondements, puis enchaîne les recherches.
