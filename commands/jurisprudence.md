---
name: jurisprudence
description: Recherche et analyse de jurisprudence judiciaire française avec citations
arguments:
  - name: question
    description: Question juridique ou situation factuelle à analyser
    required: true
  - name: juridiction
    description: Filtre optionnel ("cassation" pour Cour de cassation uniquement)
    required: false
---
...
**Filtre** : {{juridiction | default: "toutes juridictions judiciaires"}}
...
2. **Recherche** avec l'outil MCP approprié :
   - Si `juridiction` = "cassation" → utilise `juri_rechercher_cassation`
